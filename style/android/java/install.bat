REM Installs Yellowen's IntelliJ configs into your user configs.
@echo off
echo Installing Yellowen IntelliJ configs...
...
echo.
echo Restart IntelliJ or AndroidStudio, go to preferences, and apply 'YellowenAndroid'.
exit /b
